...
import org.metalab.ygor.client.Client;
...
public class YgorDaemon extends Service {
  ...
  public synchronized void doBoot() throws YgorException {
    ...
    YgorDaemon.client = new Client(config);
    YgorDaemon.client.boot();
  }
  ...
  public static Client client() {
    if (client == null)
      throw new YgorException("Client not initialized");

    return client;
  }
  
  public static void printUsageAndExit() {
    System.out.println("Usage: ygor <config file> --create");
    System.exit(1);
  }
