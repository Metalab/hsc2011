// i'd call this VMStatus.java, but that name is already take --chrysn
package org.metalab.ygor.serial.packet;

import java.io.PrintWriter;
import java.io.StringWriter;

public class RealVMStatus extends Payload {
  ...
  public RealVMStatus(TriState running, TriState singlestep, boolean reset, boolean set_interrupt, short[] ip, short[] sp, short[] sfp, boolean clear_error, boolean clear_suspend) {
